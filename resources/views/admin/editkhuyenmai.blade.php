...
<div class="main-content">
            ...
            <div class="main-content-inner">
                            ...
                            <form action="{{route('updatekm',['id'=> $sanpham->id] )}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" value="{{$sanpham->tenkm}}" id="example-email-input" name="tenkm">
                                           
                                        </div>
                                        <div class="form-group">
                                            <label for="example-url-input" class="col-form-label">mo ta</label>
                                            <input class="form-control" type="text"  value="{{$sanpham->mota}}" id="example-url-input" name="mota">
                                        </div>
                                        <div class="form-group">
                                            <label for="example-tel-input" class="col-form-label">phan tram</label>
                                            <input class="form-control" type="text"  value="{{$sanpham->phantram}}" id="example-tel-input"name="phantram">
                                        </div>
                                        <div class="form-group">
                                            <label for="example-tel-input" class="col-form-label">Ngày bắt đầu:</label>
                                            <input class="form-control" type="date"  value="{{$sanpham->ngaybatdau}}" id="example-tel-input"name="ngaybatdau">
                                        </div>
                                        <div class="form-group">
                                            <label for="example-tel-input" class="col-form-label">Ngày kết thúc:</label>
                                            <input class="form-control" type="date"  value="{{$sanpham->ngayketthuc}}" id="example-tel-input"name="ngayketthuc">
                                        </div>
